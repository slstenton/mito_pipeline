...
if [[ "${ROLE}" == 'Master' ]]; then
    ...
    git clone https://github.com/broadinstitute/gnomad_qc.git /home/gnomad_qc
    git clone https://github.com/broadinstitute/gnomad_methods.git /home/gnomad_methods
    git clone https://github.com/broadinstitute/gnomad-mitochondria.git /home/gnomad_mitochondria

    mkdir -p /home/hail/
    ln -s ln -s /home/gnomad_qc/gnomad_qc /home/hail
    ln -s ln -s /home/gnomad_mitochondria/gnomad_mitochondria /home/hail
